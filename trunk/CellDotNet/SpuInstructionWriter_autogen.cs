...
namespace CellDotNet
{
	...
	partial class SpuInstructionWriter
	{
		...
		/// </summary>
		public VirtualRegister WriteStqd(VirtualRegister ra, int value)
		{
			return WriteRI10(SpuOpCode.stqd, ra, value);
		}

		/// <summary>
		/// Store Quadword (x-form)
		/// </summary>
		public VirtualRegister WriteStqx(VirtualRegister ra, VirtualRegister rb)
		{
			return WriteRR(SpuOpCode.stqx, ra, rb);
		}

		/// <summary>
		/// Store Quadword (a-form)
		/// </summary>
		public VirtualRegister WriteStqa(int symbol)
		{
			return WriteRI16(SpuOpCode.stqa, symbol);
		}

		/// <summary>
		/// Store Quadword Instruction Relative (a-form)
		/// </summary>
		public VirtualRegister WriteStqr(int symbol)
		{
			return WriteRI16(SpuOpCode.stqr, symbol);
		}
